...
function OpenCloakroomMenu()
	...
	elseif grade == 'inspector4' then
		table.insert(elements, {label = _U('police_wear'), value = 'inspector4_wear'})
	elseif grade == 'inspector5' then
		table.insert(elements, {label = _U('police_wear'), value = 'inspector5_wear'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'inspector4_wear' or
			data.current.value == 'inspector5_wear' or
...
function OpenArmoryMenu(station)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory', {
		...
		if data.current.value == 'get_weapon' and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'komisar3' or PlayerData.job.grade_name == 'komisar2' or PlayerData.job.grade_name == 'komisar1') then
			OpenGetWeaponMenu()
		elseif data.current.value == 'put_weapon' then
			OpenPutWeaponMenu()
		elseif data.current.value == 'buy_weapons' and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'komisar3' or PlayerData.job.grade_name == 'komisar2' or PlayerData.job.grade_name == 'komisar1') then
			OpenBuyWeaponsMenu()
		elseif data.current.value == 'put_stock' then
			OpenPutStocksMenu()
		elseif data.current.value == 'get_stock' and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'komisar3' or PlayerData.job.grade_name == 'komisar2' or PlayerData.job.grade_name == 'komisar1') then
			OpenGetStocksMenu()
		end
	...
	while true do
		...
		if PlayerData.job and PlayerData.job.name == 'police' then
			...
			for k,v in pairs(Config.PoliceStations) do
				...
				if Config.EnablePlayerManagement and PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'komisar3' then
